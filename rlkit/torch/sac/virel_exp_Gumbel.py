...
from rlkit.torch.sac.policies_Gumbel import GumbelSoftmaxPolicy
from rlkit.samplers.data_collector import MdpPathCollector
from rlkit.torch.sac.virel_Gumbel import Virel
...
if __name__ == "__main__":    
    ...
    variant = dict(
        algorithm_kwargs=dict(
            ...
            min_num_steps_before_training=1000, ##10000,
            max_path_length=5,##1000,
            batch_size=128,
        ),
        trainer_kwargs=dict(
            discount=0.99,
    ...
    random.seed(seed)
    np.random.seed(seed)
    name = "virel_" + "Gumbel_" + str(env_name) + "_" + str(init_seed) + "_" + str(reward_scale) + "_" + str(beta_scale)
